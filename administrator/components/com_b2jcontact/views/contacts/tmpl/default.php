...
<?php endif;?>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				<label for="filter_search" class="element-invisible"><?php echo JText::_('COM_B2JCONTACT_FILTER_SEARCH_DESC');?></label>
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_B2JCONTACT_SEARCH_IN_NAME'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_B2JCONTACT_SEARCH_IN_NAME'); ?>" />
			</div>
		...
		<table class="table table-striped" id="articleList">
			<thead>
				<tr>
					...
					<th width="5%" class="nowrap hidden-phone">
						<?php echo JHtml::_('grid.sort', 'COM_B2JCONTACT_HEADING_ASSOCIATION', 'association', $listDirn, $listOrder); ?>
					</th>
					<?php endif;?>
					<th width="5%" class="nowrap hidden-phone">
			...
			foreach ($this->items as $i => $item) :
				...
				$canEditOwn	= $user->authorise('core.edit.own',   'com_b2jcontact') && $item->created_by == $userId;//.category.'.$item->catid
